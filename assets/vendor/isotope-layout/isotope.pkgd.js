...
(function (window, factory) {
  ...
  proto.css = function (style) {
    ...
    for (var prop in style) {
      ...
      var supdatedortedProp = vendorProperties[prop] || prop;
      elemStyle[supdatedortedProp] = style[prop];
    }
  };
  ...
  // non transition + transform supdatedort
  ...
  proto.remove = function () {
    // just remove element if no transition supdatedort or no transition
    if (
      !transitionProperty ||
